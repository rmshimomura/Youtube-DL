...
class App(Tk):
                ...
                if self.url.get().startswith("https://www.youtube.com/watch?v="):  # Check if the url is a valid youtube url
                    ...
                    if requests.get(self.url.get()).status_code == 200:
                        ...
                        if len(self.urls) > 0:
                            ...
                            self.list_of_urls = Listbox(self.links_title, height=10, width=60, highlightbackground = "black", 
    ...
    def render_buttons(self):
        ...
        self.out_dir = Button(self, text=f"Selecione a pasta de saída...{chr(10) + chr(10) + 'Atual --> ' + self.output_path if self.output_path is not None and self.output_path != '' else ''}",
